...
export interface BetApiConfig {
  apiBetId: number | null;      // ID del tipo de apuesta en API-Football
  apiEndpoint: string;           // "fixtures", "statistics", "odds"
  apiStatKey: string;            // Clave a buscar en la respuesta
  apiOperator: string;           // "greater_than", "less_than", "equals", "odd", "even"
 ...
 */
export function mapBetToApiConfig(
  betType: string,
  betLabel: string,
  homeTeam: string,
  awayTeam: string
