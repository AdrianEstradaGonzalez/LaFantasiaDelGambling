 ...
 */
import { getPlayersAvailability, syncPlayersAvailability, syncPlayerAvailability, } from '../controllers/playerStatus.controller.js';
...
const playerStatusRoutes = async (app) => {
